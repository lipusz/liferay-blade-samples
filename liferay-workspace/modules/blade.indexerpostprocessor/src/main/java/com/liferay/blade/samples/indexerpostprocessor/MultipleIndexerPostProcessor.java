...
public class MultipleIndexerPostProcessor implements IndexerPostProcessor {
	...
	@Reference(
		target = "(indexer.class.name=com.liferay.portlet.usersadmin.util.ContactIndexer)"
	)
	protected Indexer contactIndexer;

	@Reference(
		target = "(indexer.class.name=com.liferay.portlet.messageboards.util.MBMessageIndexer)"
	)
	protected Indexer mBMessageIndexer;
